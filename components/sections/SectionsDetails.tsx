    ...
    <div className="px-6 py-4 flex flex-col gap-5">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center">
        ...
        <div className="flex gap-4">
          {/* // section sidebar for Mobile screen */}
      ...
      {isLocked ? (
        <div className="px-10 flex flex-col gap-5 items-center bg-[#7ed8fb]">
      ...
      <div>
        ...
        {resources.map((resource) => (
          <Link
            ...
            target="_blank"
            className="flex items-center bg-[#caeffd] rounded-lg text-sm font-medium p-3"
          >
