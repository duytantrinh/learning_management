              ...
              >
                {(provided) => (
                  <div
                    ...
                    ref={provided.innerRef}
                    className="flex items-center bg-[#dcf2f9] rounded-lg text-sm font-medium p-3"
                  >
                    <div {...provided.dragHandleProps}>
                      <Grip className="h-4 w-4 cursor-pointer mr-4 hover:text-[#077bbe]" />
                    </div>
                    {section.title}
                    <div className="ml-auto">
                      <Pencil
                        className="h-4 w-4 cursor-pointer hover:text-[#077bbe]"
